...
unlocked to sign the COIN-Qt.app bundle.
...
allowing somebody to distribute a COIN-Qt.app or coin-qt-setup.exe with a valid
...
that the coin-qt.exe file inside the installer had not been tampered with.

...
These are the dependencies currently used by COIN. You can find instructions for installing them in the `build-*.md` file for your platform.
...
Telegram - https://t.me/coinnl
Keybase  - https://keybase.io/team/coin/

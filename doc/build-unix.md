...
memory available when compiling COIN. On systems with less, gcc can be
...
See the section "Disable-wallet mode" to build COIN without wallet.
...
# Configure COIN to use our own-built instance of BDB
cd $BITCOIN_ROOT
./autogen.sh
...
This example lists the steps necessary to setup and build a command line only, non-wallet distribution of the latest changes on Arch Linux:
    ...
    git clone https://github.com/thecoininitiators/coin.git
    cd coin/
    ./autogen.sh
...
As mentioned above, when maintaining portability of the wallet between the standard COIN distributions and independently built

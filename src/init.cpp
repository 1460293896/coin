 ...
 * between coind, and coin-qt and non-server tools.
*/
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/thecoininitiators/coin>";
    const std::string URL_WEBSITE = "<https://tropee.com/coin/>";
    ...
    return FormatParagraph(strprintf("Copyright (C) %i-%i The Bitcoin Core Developers", 2009, COPYRIGHT_YEAR)) + "\n" +
           ...
           "\n" +
           FormatParagraph(strprintf("Copyright (C) %i The COIN Developers", 2024)) + "\n" +
           "\n" +
           FormatParagraph(strprintf(_("Please contribute if you find COIN useful. "

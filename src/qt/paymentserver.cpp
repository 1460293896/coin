    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click coin: links
...
//
// OSX-specific way of handling coin: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in coin: URIs
